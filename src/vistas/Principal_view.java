...
public class Principal_view extends javax.swing.JFrame {
    ...
    Configurador controlador;
    
    public Principal_view(Configurador controlador) {
        initComponents();
        this.setLocationRelativeTo(null);
        this.setResizable(false);
        
        controlador = new Configurador();
        //controlador.setPrincipal_v(this);
    }
    ...
    private void initComponents() {
        ...
        reset_btn.setText("File");
        jMenuBar1.add(reset_btn);

        ayuda_btn.setText("Edit");
